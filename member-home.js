...
const SERVICES = [
  // ---------------- SHORT-TERM ----------------
  {
    id: 'home-nursing', category: 'Short-Term', icon: '🏠', name: 'Home Nursing',
  ...
  {
    id: 'wound-care', category: 'Short-Term', icon: '🩹', name: 'Wound Care',
  ...
  {
    id: 'infusion', category: 'Short-Term', icon: '💧', name: 'Infusion',
  ...
  {
    id: 'catheterization', category: 'Short-Term', icon: '🩺', name: 'Catheterization',
  ...
  {
    id: 'injection', category: 'Short-Term', icon: '💉', name: 'Injection',
  ...
  {
    id: 'stoma-care', category: 'Short-Term', icon: '🎗️', name: 'Stoma Care',
  ...
  {
    id: 'vital-checks', category: 'Short-Term', icon: '📊', name: 'Vital Checks',
  ...
  {
    id: 'vaccination', category: 'Short-Term', icon: '🛡️', name: 'Vaccination',
  ...
  {
    id: 'medical-escort', category: 'Short-Term', icon: '🚑', name: 'Medical Escort',
  ...
  {
    id: 'respite-care', category: 'Short-Term', icon: '🌿', name: 'Respite Care',
  ...
  {
    id: 'private-nurse-hd', category: 'Short-Term', icon: '👩‍⚕️', name: 'Private Nurse (Hourly/Daily)',
  ...
  {
    id: 'part-time-caregiver', category: 'Short-Term', icon: '🤝', name: 'Part-Time Caregiver',
  ...
  // ---------------- LONG-TERM ----------------
  {
    id: 'elderly-home-care', category: 'Long-Term', icon: '👵', name: 'Elderly Home Care',
  ...
  {
    id: 'home-care', category: 'Long-Term', icon: '🏡', name: 'Home Care',
  ...
  {
    id: 'caregiver', category: 'Long-Term', icon: '🤲', name: 'Caregiver',
  ...
  {
    id: 'private-nurse-monthly', category: 'Long-Term', icon: '📅', name: 'Private Nurse (Monthly)',
  ...
  {
    id: 'intensive-care', category: 'Long-Term', icon: '🏥', name: 'Intensive Care',
  ...
  {
    id: 'pulmonary-care', category: 'Long-Term', icon: '🫁', name: 'Pulmonary Care',
  ...
  {
    id: 'dementia-care', category: 'Long-Term', icon: '🧠', name: 'Dementia Care',
  ...
  {
    id: 'palliative-care', category: 'Long-Term', icon: '🕊️', name: 'Palliative Care',
  ...
  {
    id: 'bedridden-care', category: 'Long-Term', icon: '🛏️', name: 'Bedridden Patient Care',
  ...
  {
    id: 'rehabilitation-care', category: 'Long-Term', icon: '🦾', name: 'Rehabilitation Care',
...
function openServiceModal(serviceId) {
  ...
  dom.serviceModalIcon.textContent = service.icon;
